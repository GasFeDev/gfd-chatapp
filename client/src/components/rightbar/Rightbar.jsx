...
export default function Rightbar({ user }) {
  ...
  const [followed, setFollowed] = useState(
    currentUser.followings.includes(user && user.id)
  );
      ...
      <>
        <div className="birthdayContainer">
          ...
          <span className="birthdayText">
            <b>Gasparin Gomez Bolaños</b> y <b>3 amigos mas</b> cumplen años
            hoy.
          </span>
        </div>
        <img className="rightbarAd" src="assets/cumpleamigos.jpg" alt="" />
    ...
    return (
      <>
        ...
        <div className="rightbarInfo">
          ...
          <div className="rightbarInfoItem">
            <span className="rightbarInfoKey">Situación sentimental:</span>
